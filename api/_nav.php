...
@media(max-width:768px){.site-nav .nav-links{display:none}.hamburger{display:flex}}
</style>

<!-- Hamburger -->
<div class="hamburger" id="nav-hamburger" onclick="toggleMobMenu()">
  <span></span><span></span><span></span>
</div>
<div class="mob-overlay" id="nav-overlay" onclick="toggleMobMenu()"></div>
<div class="mob-menu" id="nav-mob-menu">
...
function toggleMobMenu(){
  ...
  document.getElementById('nav-mob-menu').classList.toggle('open');
