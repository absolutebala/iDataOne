...
.cs-hero{
  ...
  background:radial-gradient(ellipse at 10% 30%,rgba(180,83,9,0.1),transparent 45%),radial-gradient(ellipse at 90% 10%,rgba(217,119,6,0.08),transparent 40%),radial-gradient(ellipse at 60% 90%,rgba(30,41,59,0.05),transparent 40%),linear-gradient(135deg,#f8fafc 0%,#fefce8 45%,#fef3c7 100%);
}
...
.cs-badge{display:inline-block;padding:5px 14px;border-radius:999px;background:rgba(0,0,0,0.05);border:1px solid rgba(0,0,0,0.08);font-size:11px;font-weight:600;letter-spacing:2px;text-transform:uppercase;color:#b45309;margin-bottom:24px}
...
.cs-stat-num span{background:linear-gradient(90deg,#b45309,#d97706);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
