...
.cs-hero{background:radial-gradient(ellipse at 10% 30%,rgba(180,83,9,0.1),transparent 45%),radial-gradient(ellipse at 90% 10%,rgba(217,119,6,0.08),transparent 40%),linear-gradient(135deg,#f8fafc 0%,#fefce8 45%,#fef3c7 100%)}
