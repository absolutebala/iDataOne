...
<section class="section process">
  <div class="section-inner">
    ...
    <div class="process-img-wrap" style="margin-top:40px;border-radius:20px;overflow:hidden;box-shadow:0 24px 64px rgba(0,0,0,0.35)">
