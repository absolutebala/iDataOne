...
.cs-hero{background:radial-gradient(ellipse at 10% 30%,rgba(234,88,12,0.1),transparent 45%),radial-gradient(ellipse at 90% 10%,rgba(249,115,22,0.08),transparent 40%),linear-gradient(135deg,#f8fafc 0%,#fff7ed 45%,#ffedd5 100%)}
