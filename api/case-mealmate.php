...
<section class="cs-hero">
  <div class="cs-hero-inner">
    ...
    <div class="cs-hero-img">
      <img src="/assets/images/mealmate-hero.png" alt="MealMate — personalised family meal plan generated by AI" onmouseover="hzOpen(this.src,this.alt)">
    </div>
  </div>
</section>
...
<section class="cs-section cs-alt">
  <div class="cs-inner">
    ...
    <div class="cs-visual" style="padding:0;background:none;border:none">
      <img src="/assets/images/mealmate-architecture.png" alt="MealMate architecture — user experience, application personalisation, cuisine rotation engine, conversational AI chat, health and diet logic, AI meal generation, data persistence and analytics" style="width:100%;height:auto;display:block;border-radius:20px;box-shadow:0 24px 64px rgba(217,119,6,0.18),0 8px 24px rgba(15,23,42,0.12);cursor:zoom-in" onmouseover="hzOpen(this.src,this.alt)">
    </div>
