...
/* ── Mobile Responsive ── */
@media(max-width:768px){
  #presentation{display:block!important}
  .screen{position:relative!important;opacity:1!important;transform:none!important;pointer-events:auto!important;min-height:100vh;height:auto!important;padding:80px 20px 60px}
  .dots{display:none!important}
  .site-logo.large{display:none}
  .top-nav{height:56px;padding:0 20px}
  .top-nav-links{display:none}
  h1{font-size:clamp(28px,8vw,48px)!important;letter-spacing:-1.5px!important}
  h2{font-size:clamp(26px,7vw,40px)!important;letter-spacing:-1px!important;text-align:center}
  .cap-carousel{max-width:100%}
  .cap-tabs{flex-wrap:wrap;justify-content:center}
  .cap-card{grid-template-columns:1fr!important;padding:24px 20px 20px!important}
  .cap-illus{display:none!important}
  .cap-card-title{font-size:19px!important}
  ...
  .why-bottom,.cap-why-cta,.screen-cta{display:none!important}
