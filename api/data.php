  ...
  <div class="banner-inner">
    ...
    <div class="banner-illus">
      <img
        ...
        loading="eager"
        onmouseover="hzOpen(this.src,this.alt);this.style.transform='translateY(-4px)';this.style.boxShadow='0 32px 80px rgba(180,120,0,0.25),0 12px 32px rgba(0,0,0,0.14)'"
