...
.cs-hero{background:radial-gradient(ellipse at 10% 30%,rgba(217,119,6,0.1),transparent 45%),radial-gradient(ellipse at 90% 10%,rgba(245,158,11,0.08),transparent 40%),linear-gradient(135deg,#f8fafc 0%,#fffbeb 45%,#fef3c7 100%)}
