...
<?php $current_page = 'cases'; include __DIR__ . '/../includes/_nav.php'; ?>
...
<!-- AI: NivoChat Conversational AI -->
      <div class="case-card" data-cat="ai" onclick="location.href='/case-study/nivochat'" style="cursor:pointer">
        ...
        <div class="case-card-body">
          ...
          <a href="/case-study/nivochat" class="case-cta violet">View Full Case Study <svg viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
        </div>
      </div>
...
<!-- Digital: iSportOne -->
      ...
      <div class="case-card" data-cat="data" onclick="location.href='/case-study/risk-dashboard'" style="cursor:pointer">
        <div class="case-card-visual" style="background:#0a0f1e;padding:0;overflow:hidden">
          <img src="/assets/images/risk-platform-hero.png" alt="Real-Time Risk Intelligence Dashboard for an enterprise FMCG company" style="width:100%;height:200px;object-fit:cover;object-position:center center;display:block"/>
        </div>
        <div class="case-card-body">
