...
.cs-hero{
  ...
  background:radial-gradient(ellipse at 10% 30%,rgba(244,63,94,0.1),transparent 45%),radial-gradient(ellipse at 90% 10%,rgba(251,113,133,0.08),transparent 40%),radial-gradient(ellipse at 60% 90%,rgba(99,102,241,0.05),transparent 40%),linear-gradient(135deg,#f8fafc 0%,#fff1f2 45%,#ffe4e6 100%);
}
...
.cs-badge{display:inline-block;padding:5px 14px;border-radius:999px;background:rgba(0,0,0,0.05);border:1px solid rgba(0,0,0,0.08);font-size:11px;font-weight:600;letter-spacing:2px;text-transform:uppercase;color:#f43f5e;margin-bottom:24px}
