...
.cs-hero{background:linear-gradient(135deg,#0f172a 0%,#7c2d12 50%,#0f172a 100%);padding:80px 32px 60px;position:relative;overflow:hidden}
...
.cs-badge{display:inline-block;padding:5px 14px;border-radius:999px;background:rgba(244,63,94,0.15);border:1px solid rgba(244,63,94,0.25);font-size:11px;font-weight:600;letter-spacing:2px;text-transform:uppercase;color:#fb7185;margin-bottom:24px}
...
.cs-stat-num span{background:linear-gradient(90deg,#fb7185,#fda4af);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
