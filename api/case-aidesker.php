...
.cs-hero{
  ...
  background:radial-gradient(ellipse at 10% 30%,rgba(14,165,233,0.1),transparent 45%),radial-gradient(ellipse at 90% 10%,rgba(56,189,248,0.08),transparent 40%),radial-gradient(ellipse at 60% 90%,rgba(99,102,241,0.05),transparent 40%),linear-gradient(135deg,#f8fafc 0%,#f0f9ff 45%,#e0f2fe 100%);
}
...
.cs-badge{display:inline-block;padding:5px 14px;border-radius:999px;background:rgba(0,0,0,0.05);border:1px solid rgba(0,0,0,0.08);font-size:11px;font-weight:600;letter-spacing:2px;text-transform:uppercase;color:#0ea5e9;margin-bottom:24px}
