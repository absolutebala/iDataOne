...
.cs-hero{background:linear-gradient(135deg,#0f172a 0%,#0c2d48 50%,#0f172a 100%);padding:80px 32px 60px;position:relative;overflow:hidden}
...
.cs-badge{display:inline-block;padding:5px 14px;border-radius:999px;background:rgba(14,165,233,0.15);border:1px solid rgba(14,165,233,0.25);font-size:11px;font-weight:600;letter-spacing:2px;text-transform:uppercase;color:#38bdf8;margin-bottom:24px}
...
.cs-stat-num span{background:linear-gradient(90deg,#38bdf8,#0ea5e9);-webkit-background-clip:text;-webkit-text-fill-color:transparent}
