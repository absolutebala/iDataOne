...
<section class="cs-cta">
  <div class="cs-cta-card">
    ...
    <div style="position:relative;z-index:1;display:flex;gap:12px;flex-wrap:wrap;flex-shrink:0">
      <a href="https://nivochat.idataone.com/" target="_blank" rel="noopener" class="cs-cta-btn" style="background:#fff;color:#0f172a">Sign Up on NivoChat <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#0f172a" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
