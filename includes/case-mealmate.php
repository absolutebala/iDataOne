...
<section class="cs-hero">
  <div class="cs-hero-inner">
    ...
    <div class="cs-hero-img">
      <span class="hz-wrap"><img src="/assets/images/mealmate-hero.png" alt="MealMate — personalised family meal plan generated by AI" onclick="hzOpen(this.src,this.alt)" onmouseover="hzHover(this)"><span class="hz-icon"><svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.3-4.3"/><path d="M11 8v6M8 11h6"/></svg></span></span>
    </div>
  </div>
</section>
...
<section class="cs-section cs-alt">
  <div class="cs-inner">
    ...
    <div class="cs-visual" style="padding:0;background:none;border:none">
      <span class="hz-wrap"><img src="/assets/images/mealmate-architecture.png" alt="MealMate architecture — user experience, application personalisation, cuisine rotation engine, conversational AI chat, health and diet logic, AI meal generation, data persistence and analytics" style="width:100%;height:auto;display:block;border-radius:20px;box-shadow:0 24px 64px rgba(217,119,6,0.18),0 8px 24px rgba(15,23,42,0.12);cursor:zoom-in" onclick="hzOpen(this.src,this.alt)" onmouseover="hzHover(this)"><span class="hz-icon"><svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.3-4.3"/><path d="M11 8v6M8 11h6"/></svg></span></span>
    </div>
